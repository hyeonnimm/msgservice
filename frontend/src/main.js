...
pluralCaseList.push( {plural: "reservations/msgLists", pascal: "ReservationMsgList"} )

pluralCaseList.push( {plural: "sends/msgs", pascal: "SendMsg"} )

pluralCaseList.push( {plural: "raters/rates", pascal: "RaterRate"} )
